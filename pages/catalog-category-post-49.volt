                ...
                <div class="mix second-row col-md-4 category-2 category-3">
                    <div class="thumb-holder">
                        <a href="/{{ language }}/p/{{ post.slug|getAttribute(language) }}.html">
                            <div
                                style="background-image: url('http://cetec.vn{{ post.data.image[0].url }}'); background-size: cover; background-position: center; height: 300px">
                            </div>
                        </a>
                        <div class="thumb-content">
                            ...
                            <div class="thumb-text">
                                <a href="/{{ language }}/p/{{ post.slug|getAttribute(language) }}.html">
                                    <h4>{{ post.data.title|getAttribute(language) }}</h4>
                                </a>
                                <span><i class="fa fa-folder-o"></i>{{ post.data.desc|getAttribute(language)|striptags
                                    }}</span>
                            </div>
                        </div>
                    </div>
