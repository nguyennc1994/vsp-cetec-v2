...
{% block content %}
    ...
    <!--====================  breadcrumb area ====================-->
    <div class="breadcrumb-area bg-img"  style="background-image: url('http://cetec.vn/content/uploads/cms/2021/06/28/funfact-bg.jpg')">
        <div class="container">
            <div class="row">
                <div class="col">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12 order-2 order-lg-1">
                        <div class="sidebar">
                            <h3 class="sidebar-title">Công trình nổi bật</h3>
                            <ul class="sidebar-list">
                                {{ render_widget('post-listing',['catalog':'category','category':[4],'limit':10],['viewsDir': widgets_volt,'view':'list-leftcongtrinh']) }}
                            </ul>
                        </div>
                    </div>
                </div>
