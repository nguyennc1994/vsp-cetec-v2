            ...
            <div class="row section-space--bottom--50">
                <div class="col">
                    <div id="contact-map" class="contact-map">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.930335234667!2d105.81676881483233!3d21.03547328599478!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab0d14762d23%3A0xd5e263c36363fa8d!2zMjg1IMSQ4buZaSBD4bqlbg!5e0!3m2!1svi!2s!4v1563341809939!5m2!1svi!2s" width="100%" height="100%" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
                    ...
                    <div class="contact-information">
                        ...
                        <ul>
                            <li>
                                ...
                                <span class="text"><span>Trụ sở: Tầng 6 tòa nhà HKC 285 Đội Cấn, Ba Đình, Hà Nội</span></span>
                            </li>
                            <li>
                                <span class="icon"><i class="ion-android-map"></i></span>
                            ...
                            <li>
                                ...
                                <span class="text"><a href="tel:02462510665">Phone: (024) 62510665</a><a href="tel:0393048288">Hotline: 039 304 8288</a></span>
                            </li>
                            <li>
                                <span class="icon"><i class="ion-ios-email-outline"></i></span>
                                <span class="text"><a href="mailto:contact@cetec.vn">Email:contact@cetec.vn</a><a href="http://www.cetec.vn/">Website: www.cetec.vn</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="contact-form">
                        ...
                        <form id="contact-form" method="post">
                            <div class="row row-10">
                                <div class="col-md-6 col-12 section-space--bottom--20"><input name="con_name" type="text" placeholder="Họ và tên"></div>
                                <div class="col-md-6 col-12 section-space--bottom--20"><input name="con_email" type="email" placeholder="Email"></div>
                                <div class="col-12"><textarea name="con_message" placeholder="Liên hệ"></textarea></div>
                                <div class="col-12"><div id="recaptcha_1" class="recaptcha"></div></div>
