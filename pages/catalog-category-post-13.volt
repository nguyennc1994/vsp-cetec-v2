      ...
      <div class="container">
          <div class="row">
            ...
            <div class="col-lg-8 col-12 order-1 order-lg-2">
              <div class="row">
                {% for post in items %}
                <div class="col-lg-6 col-sm-6 col-12 section-space--bottom--30">
                              <div class="service-grid-item service-grid-item--style2">
                                  <div class="service-grid-item__image imgkh">
...
<style type="text/css">
  .brand-logo-slider-area.grey-bg.section-space--inner--60{display: none !important;}
</style>
